...
const FAQS = [
  { q:"What if Halo gets something wrong?", a:"Halo uses a confidence score on every message. At 80% confidence or above, it replies automatically — no input needed. Between 50 and 79%, it sends you a one-tap approval on WhatsApp before anything goes out. Below 50%, it escalates to you directly. Nothing reaches a customer without meeting the threshold — and every decision is logged so you can see exactly why Halo acted the way it did." },
...
const COMPARISON = [
  ...
  { f:"Confidence-based routing", manual:"No",             bot:"No",                halo:"80%+ auto · 50–79% approval · <50% escalate" },
...
const ConfidenceSection = () => {
  ...
  const tiers = [
    ...
    { range:"50–79%", label:"Approval needed", color:T.yellow, bg:T.yellowBg, desc:"Genuinely ambiguous situations — Halo sends you a one-tap WhatsApp notification with the suggested reply. Approve, edit, or dismiss in seconds." },
